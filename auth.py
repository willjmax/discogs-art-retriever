...
class auth:
	...
	def __init__(self):
		...
		resp, content = client.request(request_token_url, "POST", headers={"User-Agent": self.user_agent})
		...
		resp, content = client.request(access_token_url, "POST", headers={'User-Agent': self.user_agent})
